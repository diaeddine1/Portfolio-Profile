  ...
  Experiences = [
    {
      ...
      exp: [
        ...
        { year: "OCTOBRE 2024 - AVRIL 2025", title: 'Data Scientist', description: 'Développé des modèles prédictifs pour optimiser les ventes, la planification des repas et réduire le gaspillage alimentaire de plus de 3 tonnes/mois dans les restaurants et buffets.' },
        { year: "MARS - SEPTEMBRE 2024", title: 'Stage de Fin d\'étude', description: 'Création d\'une plateforme d\'automatisation des décisions reposant sur un modèle de machine learning, destinée à remplacer IBM ODM Decision Center, et à être hébergée sur AWS Cloud.' },
    ...
    },
    {
      ...
      exp: [
        ...
        { year: "OCTOBER 2024 - APRIL 2025", title: "Data Scientist", description: "Developed predictive models to optimize sales, meal planning, and reduce food waste by over 3 tons per month in restaurants and buffets." },
        { year: "MARCH - SEPTEMBER 2024", title: 'End Of Studies Internship', description: 'Creation of a decision automation platform based on a machine learning model, intended to replace IBM ODM Decision Center, and to be hosted on AWS Cloud.' },
